	...
	const frontendDashboardRoutes: RouteObject[] = [
		{
			...
			element: <AuthGuard allowedRoles={["ADMIN"]}>{Component("/pages/management/locations")}</AuthGuard>,
		},
		{
			path: "management/transportations",
			element: <AuthGuard allowedRoles={["ADMIN"]}>{Component("/pages/management/transportations")}</AuthGuard>,
		},
		{
			path: "routes",
			element: <AuthGuard allowedRoles={["ADMIN", "AGENCY"]}>{Component("/pages/routes")}</AuthGuard>,
		},
